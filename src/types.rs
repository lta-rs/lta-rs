...
#[derive(Debug, Clone, PartialEq, Eq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub enum GetBusArrivalAcceptParameter {
    #[cfg_attr(feature = "serde", serde(rename = "application/json"))]
    ApplicationJson,
    #[cfg_attr(feature = "serde", serde(rename = "application/atom+xml"))]
    ApplicationAtomXml,
}
impl GetBusArrivalAcceptParameter {
    pub const fn as_str(&self) -> &'static str {
        match self {
            Self::ApplicationJson => "application/json",
            Self::ApplicationAtomXml => "application/atom+xml",
        }
    }
}
impl AsRef<str> for GetBusArrivalAcceptParameter {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
impl fmt::Display for GetBusArrivalAcceptParameter {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.write_str(self.as_str())
    }
}
