...
| Traffic | `/v3/TrafficSpeedBands` | `getTrafficSpeedBands` | Good wire support. String numeric parsing is supported for link ID, speeds, and coordinates. | Wrapper exposure. | F1, F2 |
| Traffic | `/Traffic-Imagesv2` | `getTrafficImages` | Good wire support. Camera ID string parsing and numeric coordinates are supported. | Wrapper exposure. | F1, F2 |
| Traffic | `/TrafficIncidents` | `getTrafficIncidents` | Good wire support. Open string incident enum is representable. | Wrapper exposure. | F1, F2 |
